...
## 🍀1. 프로젝트 개요<a id="프로젝트-개요">
무엇을 먹을지 고민하는 우리에게 꼭 필요한 AI기반 레시피 추천 서비스입니다.

---


### 1.1 프로젝트 소개<a id="프로젝트-소개">
...
### 1.3 유사 서비스와의 차별성<a id="유사-서비스와의-차별성">
...
<br>
<a id="DDD>
# ✔️ DDD - Bounded Context<a id="DDD-Bounded-Context">
